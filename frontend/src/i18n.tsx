...
const dict: Record<string, Entry> = {
  ...
  'alerts.pricePh':     { en: 'Enter crop price…', hi: 'फसल की कीमत डालें…', pa: 'ਫ਼ਸਲ ਦਾ ਭਾਅ ਦਾਖਲ ਕਰੋ…', mr: 'पिकाची किंमत टाका…' },
  'alerts.setBtn':      { en: 'Set Alert', hi: 'सेट करें', pa: 'ਸੈੱਟ ਕਰੋ', mr: 'सेट करा' },
  'alerts.validRange':   { en: 'Valid range: ₹{min} – ₹{max}', hi: 'मान्य सीमा: ₹{min} – ₹{max}', pa: 'ਮਾਨਯੋਗ ਸੀਮਾ: ₹{min} – ₹{max}', mr: 'वैध श्रेणी: ₹{min} – ₹{max}' },
  'alerts.rangeHint':    { en: 'You can enter any price between ₹{min} – ₹{max}', hi: 'आप ₹{min} से ₹{max} के बीच कोई भी कीमत भर सकते हैं', pa: 'ਤੁਸੀਂ ₹{min} ਤੋਂ ₹{max} ਵਿਚਕਾਰ ਕੋਈ ਵੀ ਕੀਮਤ ਦਾਖਲ ਕਰ ਸਕਦੇ ਹੋ', mr: 'तुम्ही ₹{min} ते ₹{max} दरम्यान कोणतीही किंमत भरू शकता' },
  'alerts.outOfRange':   { en: 'Price must be between ₹{min} – ₹{max}', hi: 'कीमत ₹{min} से ₹{max} के बीच होनी चाहिए', pa: 'ਕੀਮਤ ₹{min} ਤੋਂ ₹{max} ਵਿਚਕਾਰ ਹੋਣੀ ਚਾਹੀਦੀ ਹੈ', mr: 'किंमत ₹{min} ते ₹{max} दरम्यान असावी' },
  ...
  'alerts.bestDayForCrops': { en: 'You\'ll get best day alert for your selected crops:', hi: 'आपने जो फसलें चुनी हैं, उनका बेस्ट डे अलर्ट मिलेगा:', pa: 'ਤੁਸੀਂ ਜੋ ਫਸਲਾਂ ਚੁਣੀਆਂ ਹਨ, ਉਨ੍ਹਾਂ ਦਾ ਬੈਸਟ ਡੇ ਅਲਰਟ ਮਿਲੇਗਾ:', mr: 'तुम्ही निवडलेल्या पिकांचा बेस्ट डे अलर्ट मिळेल:' },
  ...
  'profile.terms':         { en: 'Terms & Conditions', hi: 'नियम और शर्तें', pa: 'ਨਿਯਮ ਅਤੇ ਸ਼ਰਤਾਂ', mr: 'अटी व शर्ती' },
  'profile.termsSub':      { en: 'Usage policy', hi: 'उपयोग नीति', pa: 'ਵਰਤੋਂ ਨੀਤੀ', mr: 'वापर धोरण' },
  'profile.t1title':       { en: 'Data Usage', hi: 'डेटा उपयोग', pa: 'ਡੇਟਾ ਵਰਤੋਂ', mr: 'डेटा वापर' },
  'profile.t1body':        { en: 'MandiQ collects your name, mobile number, location, and selected crops to provide personalized price alerts and predictions. Your data is stored securely and never shared with third parties without consent.', hi: 'मंडीक्यू आपका नाम, मोबाइल नंबर, स्थान और चुनी हुई फसलें व्यक्तिगत मूल्य अलर्ट और पूर्वानुमान देने के लिए एकत्र करता है। आपका डेटा सुरक्षित रखा जाता है और बिना अनुमति किसी तीसरे पक्ष को नहीं दिया जाता।', pa: 'ਮੰਡੀਕਿਊ ਤੁਹਾਡਾ ਨਾਮ, ਮੋਬਾਈਲ ਨੰਬਰ, ਟਿਕਾਣਾ ਅਤੇ ਫ਼ਸਲਾਂ ਇਕੱਠਾ ਕਰਦਾ ਹੈ। ਤੁਹਾਡਾ ਡੇਟਾ ਸੁਰੱਖਿਅਤ ਰੱਖਿਆ ਜਾਂਦਾ ਹੈ।', mr: 'मंडीक्यू तुमचे नाव, मोबाइल क्रमांक, स्थान आणि पिके गोळा करते. तुमचा डेटा सुरक्षित ठेवला जातो.' },
  'profile.t2title':       { en: 'Price Accuracy Disclaimer', hi: 'कीमत सटीकता अस्वीकरण', pa: 'ਭਾਅ ਸਟੀਕਤਾ ਬਾਰੇ', mr: 'किंमत अचूकता अस्वीकरण' },
  'profile.t2body':        { en: 'Prices and predictions shown in MandiQ are based on AGMARKNET data and AI models. Actual mandi prices may vary. MandiQ is not responsible for any financial loss arising from decisions made based on this data.', hi: 'मंडीक्यू में दिखाई गई कीमतें और पूर्वानुमान AGMARKNET डेटा और AI मॉडल पर आधारित हैं। वास्तविक मंडी कीमतें अलग हो सकती हैं। इस डेटा के आधार पर लिए गए किसी भी निर्णय से होने वाले वित्तीय नुकसान के लिए मंडीक्यू जिम्मेदार नहीं है।', pa: 'ਮੰਡੀਕਿਊ ਵਿੱਚ ਦਿਖਾਈਆਂ ਕੀਮਤਾਂ AGMARKNET ਡੇਟਾ ਅਤੇ AI ਮਾਡਲਾਂ ਉੱਤੇ ਆਧਾਰਿਤ ਹਨ। ਅਸਲ ਕੀਮਤਾਂ ਵੱਖ ਹੋ ਸਕਦੀਆਂ ਹਨ।', mr: 'मंडीक्यूमधील किंमती AGMARKNET डेटा व AI मॉडेलवर आधारित आहेत. प्रत्यक्ष किंमती वेगळ्या असू शकतात.' },
  'profile.t3title':       { en: 'Notification Consent', hi: 'सूचना सहमति', pa: 'ਸੂਚਨਾ ਸਹਿਮਤੀ', mr: 'सूचना संमती' },
  'profile.t3body':        { en: 'By enabling price alerts or Best Day alerts, you consent to receive push notifications from MandiQ. You can withdraw consent at any time by disabling alerts or turning off notifications in your device settings.', hi: 'कीमत अलर्ट या बेस्ट डे अलर्ट चालू करके आप मंडीक्यू से पुश नोटिफिकेशन प्राप्त करने की सहमति देते हैं। आप कभी भी अलर्ट बंद करके या डिवाइस सेटिंग से नोटिफिकेशन बंद करके सहमति वापस ले सकते हैं।', pa: 'ਅਲਰਟ ਚਾਲੂ ਕਰਕੇ ਤੁਸੀਂ ਮੰਡੀਕਿਊ ਤੋਂ ਸੂਚਨਾਵਾਂ ਪ੍ਰਾਪਤ ਕਰਨ ਲਈ ਸਹਿਮਤ ਹੁੰਦੇ ਹੋ।', mr: 'अलर्ट चालू करून तुम्ही मंडीक्यूकडून सूचना मिळवण्यास संमती देता.' },
  'profile.t4title':       { en: 'Farmer Data Privacy', hi: 'किसान डेटा गोपनीयता', pa: 'ਕਿਸਾਨ ਡੇਟਾ ਗੁਪਤਤਾ', mr: 'शेतकरी डेटा गोपनीयता' },
  'profile.t4body':        { en: 'Your farming details — crops, district, market — are used only to improve your experience. We do not sell or rent your personal information to advertisers or other companies.', hi: 'आपकी खेती की जानकारी — फसलें, जिला, मंडी — केवल आपके अनुभव को बेहतर बनाने के लिए उपयोग की जाती है। हम आपकी व्यक्तिगत जानकारी किसी विज्ञापनदाता या अन्य कंपनी को नहीं बेचते या किराए पर नहीं देते।', pa: 'ਤੁਹਾਡੀ ਖੇਤੀ ਜਾਣਕਾਰੀ ਸਿਰਫ਼ ਤੁਹਾਡੇ ਤਜ਼ਰਬੇ ਨੂੰ ਬਿਹਤਰ ਬਣਾਉਣ ਲਈ ਵਰਤੀ ਜਾਂਦੀ ਹੈ।', mr: 'तुमची शेतकरी माहिती फक्त तुमचा अनुभव सुधारण्यासाठी वापरली जाते.' },
  'profile.t5title':       { en: 'AI Prediction Disclaimer', hi: 'AI पूर्वानुमान अस्वीकरण', pa: 'AI ਭਵਿੱਖਬਾਣੀ ਬਾਰੇ', mr: 'AI अंदाज अस्वीकरण' },
  'profile.t5body':        { en: 'MandiQ\'s AI predictions are for informational purposes only. They do not constitute financial advice. Farmers and traders should exercise their own judgement when making buying or selling decisions.', hi: 'मंडीक्यू के AI पूर्वानुमान केवल जानकारी के उद्देश्य से हैं। ये वित्तीय सलाह नहीं हैं। किसानों और व्यापारियों को खरीद या बिक्री के निर्णय लेते समय अपने विवेक का उपयोग करना चाहिए।', pa: 'ਮੰਡੀਕਿਊ ਦੀਆਂ AI ਭਵਿੱਖਬਾਣੀਆਂ ਸਿਰਫ਼ ਜਾਣਕਾਰੀ ਲਈ ਹਨ, ਵਿੱਤੀ ਸਲਾਹ ਨਹੀਂ।', mr: 'मंडीक्यूचे AI अंदाज फक्त माहितीसाठी आहेत, आर्थिक सल्ला नाहीत.' },
  'profile.t6title':       { en: 'Contact & Grievance', hi: 'संपर्क और शिकायत', pa: 'ਸੰਪਰਕ ਅਤੇ ਸ਼ਿਕਾਇਤ', mr: 'संपर्क आणि तक्रार' },
  'profile.t6body':        { en: 'For any queries, data deletion requests, or grievances, contact us at alphacoders111@gmail.com. We aim to respond within 48 hours.', hi: 'किसी भी प्रश्न, डेटा हटाने के अनुरोध, या शिकायत के लिए alphacoders111@gmail.com पर संपर्क करें। हम 48 घंटों के भीतर जवाब देने का प्रयास करते हैं।', pa: 'ਕਿਸੇ ਵੀ ਸਵਾਲ ਜਾਂ ਸ਼ਿਕਾਇਤ ਲਈ alphacoders111@gmail.com \'ਤੇ ਸੰਪਰਕ ਕਰੋ।', mr: 'कोणत्याही प्रश्नासाठी alphacoders111@gmail.com वर संपर्क करा.' },
  'profile.termsFooter':   { en: 'Last updated: August 2025 · MandiQ v1.0', hi: 'अंतिम अपडेट: अगस्त 2025 · मंडीक्यू v1.0', pa: 'ਆਖਰੀ ਅੱਪਡੇਟ: ਅਗਸਤ 2025 · ਮੰਡੀਕਿਊ v1.0', mr: 'शेवटचे अपडेट: ऑगस्ट 2025 · मंडीक्यू v1.0' },
  ...
  'crops.ridgegourd':  { en: 'Ridge Gourd', hi: 'नेनुआ', pa: 'ਤੋਰੀ', mr: 'दोडका' },
  'crops.okra':        { en: 'Okra', hi: 'भिंडी', pa: 'ਭਿੰਡੀ', mr: 'भेंडी' },
  'crops.longbeans':   { en: 'Long Beans', hi: 'बोड़ा', pa: 'ਲੰਮੀ ਫਲੀ', mr: 'चवळी' },
  ...
  'mandi.prayagraj':       { en: 'Prayagraj Mandi', hi: 'प्रयागराज मंडी', pa: 'ਪ੍ਰਯਾਗਰਾਜ ਮੰਡੀ', mr: 'प्रयागराज मंडी' },
  'mandi.prayagraj.desc':  { en: 'UP (Prayagraj)', hi: 'उ.प्र. (प्रयागराज)', pa: 'ਯੂਪੀ (ਪ੍ਰਯਾਗਰਾਜ)', mr: 'यूपी (प्रयागराज)' },
  'mandi.prayagraj.short': { en: 'Prayagraj', hi: 'प्रयागराज', pa: 'ਪ੍ਰਯਾਗਰਾਜ', mr: 'प्रयागराज' },
  'state.up':              { en: 'Uttar Pradesh', hi: 'उत्तर प्रदेश', pa: 'ਉੱਤਰ ਪ੍ਰਦੇਸ਼', mr: 'उत्तर प्रदेश' },
  'home.selectState':      { en: 'Select State', hi: 'राज्य चुनें', pa: 'ਰਾਜ ਚੁਣੋ', mr: 'राज्य निवडा' },
