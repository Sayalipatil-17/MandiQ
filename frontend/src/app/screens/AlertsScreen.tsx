    ...
    <div className="min-h-screen bg-[#f4f6f4] pb-20 max-w-md mx-auto mq-fadein">
      ...
      <div className="px-5 py-4 space-y-4">
        ...
        <div className="bg-white rounded-3xl p-5 border border-gray-100 shadow-sm">
          ...
          {/* Selected mandi chip */}
          <div className="flex items-center gap-1.5 bg-[#e8f5e9] border border-[#2d6a3e]/20 rounded-xl px-3 py-2 mb-4 w-fit">
            <span className="text-xs">📍</span>
            <span className="text-xs font-semibold text-[#2d6a3e]">{selectedMarket}</span>
          </div>
